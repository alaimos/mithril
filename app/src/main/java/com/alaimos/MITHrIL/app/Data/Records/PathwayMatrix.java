...
public record PathwayMatrix(String pathwayId, MatrixInterface<?> matrix, Int2ObjectMap<String> index2Id,
    ...
    public static @NotNull PathwayMatrix of(Pathway p, MatrixInterface<?> matrix, Int2ObjectMap<String> index2id,
                                            Object2IntOpenHashMap<String> id2index) {
        return new PathwayMatrix(p.id(), matrix, index2id, id2index);
    }

    @Contract("_, _ -> new")
    public static @NotNull PathwayMatrix of(@NotNull PathwayMatrix m, @NotNull MatrixFactoryInterface<?> matrixFactory) {
