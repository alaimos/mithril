...
public class MetapathwayMatrixBuilder implements Runnable {

    private static final Logger log = LoggerFactory.getLogger(MetapathwayMatrixBuilder.class);
    private final MetapathwayOptions options;
    private final Random random;
    private Repository metapathway = null;


    public MetapathwayMatrixBuilder(MetapathwayOptions options, Random random) {
