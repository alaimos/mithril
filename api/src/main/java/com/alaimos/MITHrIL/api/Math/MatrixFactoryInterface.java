...
public interface MatrixFactoryInterface<E extends MatrixInterface<E>> extends ExtensionInterface {
    ...
    /**
     * Set the maximum number of threads to use for the operations. This operation is not guaranteed to be supported by
     * all implementations. Some implementations may ignore this setting. Refer to the documentation of the
