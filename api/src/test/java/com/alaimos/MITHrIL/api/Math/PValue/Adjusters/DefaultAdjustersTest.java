...
class DefaultAdjustersTest {

    @Contract(value = " -> new", pure = true)
    public static double @NotNull [] p() {
        return new double[]{
                0.575155, 0.8179539, 0.1190654, 0.943789, 0.89713, 0.08633331, 0.6448587, 0.2058494,
    ...
    public void testBonferroni() {
        ...
        assertArrayEquals(e, new Bonferroni().adjust(p), 0.0000001);
    }
    ...
    public void testHolm() {
        ...
        assertArrayEquals(e, new Holm().adjust(p), 0.0000001);
    }
    ...
    public void testHochberg() {
        ...
        assertArrayEquals(e, new Hochberg().adjust(p), 0.0000001);
    }
    ...
    public void testBenjaminiHochberg() {
        double[] p = p(),
                e = new double[]{
                        0.7414352, 0.8802645, 0.2126168, 0.943789, 0.9304775, 0.1598765, 0.7626063, 0.3430823,
        ...
        assertArrayEquals(e, new BenjaminiHochberg().adjust(p), 0.0000001);
    }
    ...
    public void testBenjaminiYekutieli() {
        double[] p = p(),
                e = new double[]{
                        1, 1, 0.9566068, 1, 1, 0.7193172, 1, 1, 1, 1, 1, 1, 1, 1, 1, 0.6654462, 1, 0.5033728,
        ...
        assertArrayEquals(e, new BenjaminiYekutieli().adjust(p), 0.0000003);
    }

    @Test
    public void testNone() throws Exception {
        double[] p = p(),
                pp = new None().adjust(p);
