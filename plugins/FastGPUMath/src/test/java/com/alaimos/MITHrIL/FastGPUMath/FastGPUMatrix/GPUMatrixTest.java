...
class GPUMatrixTest {
    ...
    protected GPUMatrixFactory factory = new GPUMatrixFactory();
    protected GPUMatrix m1;
    protected GPUMatrix m2;
    ...
    void serializeTest() throws IOException {
        var file = "test.bin";
        var writer = new BinaryWriter<GPUMatrix>();
        writer.write(file, m1);
        assertTrue(new File(Utils.getAppDir(), file).exists());
        var reader = new BinaryReader<>(GPUMatrix.class);
